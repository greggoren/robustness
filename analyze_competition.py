...
class analysis:
    ...
    def create_epsilon_for_Lambda_mart(self, competition_data,svm,banned_queries):
        ...
        for key_lambdaMart in kendall:
            ...
            nd=str(round(np.median([float(a) for a in metrics[key_lambdaMart][0] if metrics[key_lambdaMart][0].index(a) in [3,5,6,8]]),3))
            map=str(round(np.median([float(a) for a in metrics[key_lambdaMart][1] if metrics[key_lambdaMart][1].index(a) in [3,5,6,8]]),3))
            ...
            mrr=str(round(np.median([float(a) for a in metrics[key_lambdaMart][2] if metrics[key_lambdaMart][2].index(a) in [3,5,6,8]]),3))
            p=str(round(np.median([float(a) for a in metrics[key_lambdaMart][3] if metrics[key_lambdaMart][3].index(a) in [3,5,6,8]]),3))
