...
create_scatter_plot("WC as a function of ||w|| on  competition data", "wc_scatter_on_norm", "||w||",
                    "TC", C, wc)
create_scatter_plot("KT as function of ||w|| on competition data", "kt_scatter_on_norm", "||w||",
                    "KT", C, kt)
C, rbo = pickle.load(open("rbo", 'rb'))
create_scatter_plot("RBO as function of ||w|| on competition data", "rbo_scatter_on_norm", "||w||",
                    "RBO", C, rbo)
