...
leaves, mean, max = pickle.load(open("mean_max_leaves_w_kt", 'rb'))
...
create_scatter_plot("Weighted kendall tau (max aggregation) as function of #leaves", "max_leaves", "#leaves",
                    "Weighted KT", leaves, max)
