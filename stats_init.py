...
if __name__=="__main__":
    g = float(sys.argv[1])
    initial_model = load_model(sys.argv[2])
    ...
    for gamma in gammas:
        ...
        for train,test in folds:
            ...
            model_handler.fit_model_on_train_set_and_choose_best_opt(X,X_i,y_i,validation_set,fold_number,queries,score_file,gamma,initial_model,evaluator)
