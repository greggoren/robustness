...
if __name__=="__main__":
    ...
    mhs= [("model_handler_ent_opt_sh.pickle0.001",'0.001','b'),("model_handler_ent_opt_sh.pickle0.01",'0.01','g'),("model_handler_ent_opt_sh.pickle0.1",'0.1','r'),("model_handler_ent_opt_sh.pickle0.2",'0.2','m'),("data/model_handler_asr_cmp.pickle",'svm','k')]
