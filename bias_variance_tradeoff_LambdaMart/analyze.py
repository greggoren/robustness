...
class analyze:
    ...
    def create_table(self, competition_data, models, banned_queries):
        ...
        f.write(
            "Kendall-$\\tau$ & " + str(round(corr_trees[0]), 3) + " (" + str(round(corr_trees[1]), 3) + ") & " + round(
                str(
        ...
        f.write("Kendall-$\\tau$ max normalized & " + str(round(corr_trees[0]), 3) + " (" + str(round(corr_trees[1]),
                                                                                                3) + ") & " + round(
            str(
                corr_leaves[0]), 3) + " (" + str(round(corr_leaves[1]), 3) + ")   \\\\ \n")
