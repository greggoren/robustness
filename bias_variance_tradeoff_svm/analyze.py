...
class analyze:
    ...
    def create_table(self, competition_data, svms, banned_queries):
        ...
        f.write(
            "KTD & " + str(round(corr_trees[0], 3)) + " (" + str(round(corr_trees[1], 3)) + ")   \\\\ \n")
        ...
        f.write(
            "WC diff& " + str(round(corr_trees[0], 3)) + " (" + str(
                round(corr_trees[1], 3)) + ") &  \\\\ \n")
        corr_trees = spearmanr(C_for_pearson, wc_rel_for_pearson)
        f.write(
            "WC rel & " + str(round(corr_trees[0], 3)) + " (" + str(round(corr_trees[1], 3)) + ") \\\\ \n")
        ...
        f.write(
            "KTD rel & " + str(round(corr_trees[0], 3)) + " (" + str(round(corr_trees[1], 3)) + ") \\\\ \n")
        ...
        corr_trees = spearmanr(C_for_pearson, wc_rel_n_for_pearson)
        f.write("WC rel norm & " + str(round(corr_trees[0], 3)) + " (" + str(round(corr_trees[1], 3)) + ") \\\\ \n")
        corr_trees = spearmanr(C_for_pearson, wc_sum_n_for_pearson)
        f.write("WC sum norm & " + str(round(corr_trees[0], 3)) + " (" + str(round(corr_trees[1], 3)) + ") \\\\ \n")
        corr_trees = spearmanr(C_for_pearson, kendall_diff_n_for_pearson)
        f.write("KTD diff norm & " + str(round(corr_trees[0], 3)) + " (" + str(round(corr_trees[1], 3)) + ") \\\\ \n")
        corr_trees = spearmanr(C_for_pearson, kendall_rel_n_for_pearson)
        f.write("KTD rel norm & " + str(round(corr_trees[0], 3)) + " (" + str(round(corr_trees[1], 3)) + ") \\\\ \n")
        corr_trees = spearmanr(C_for_pearson, kendall_sum_n_for_pearson)
        f.write("KTD sum norm & " + str(round(corr_trees[0], 3)) + " (" + str(round(corr_trees[1], 3)) + ") \\\\ \n")
        corr_trees = spearmanr(C_for_pearson, ndcg_for_pearson)
        f.write("NDCG & " + str(round(corr_trees[0], 3)) + " (" + str(round(corr_trees[1], 3)) + ") \\\\ \n")
